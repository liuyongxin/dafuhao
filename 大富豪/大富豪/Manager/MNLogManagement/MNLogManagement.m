...
//  大富豪
//
//  Created by Louis on 16/6/28.
//  Copyright © 2016年 大富豪. All rights reserved.
//

#import "MNLogManagement.h"
...
{
    MNLogManagement* manager = [MNLogManagement sharedMNLogManagement];
...
@interface MNLogManagement ()

@end

@implementation MNLogManagement

+ (MNLogManagement *)sharedMNLogManagement {
    static MNLogManagement*sharedMNLogManagement = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedMNLogManagement = [[MNLogManagement alloc] init];
    });
    return sharedMNLogManagement;
}

+ (MNLogManagement *)sharedInstance
{
    return [self sharedMNLogManagement];
}
